...
<div class="card card-body">
    <h1 class="text-center font-weight-bold " style="font-size:2rem">Login </h1>
    <form >
        ...
        <button type="submit" class="btn btn-bus d-bloc mx-auto btn-lg btn-block" :disabled="loading" @click="login">Login</button>

        <p class="text-muted container mt-5 mx-auto text-center font-weight-bold">Don't have an account? <a href="/register" style="color:#e43a15 "> Create an account</a></p>
